const propiedades_venta = [
    ...
    },
    {
        ...
        nombre: 'Casa en Venta Barcelona',
        src: 'https://images.unsplash.com/photo-1567496898669-ee935f5f647a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fGNvbmRvfGVufDB8MHwwfHx8MA%3D%3D&auto=format&fit=crop&w=1000&q=60',
    ...
    const propiedadesLimitadas = propiedades_venta.slice(0, 3)

for(propiedad of propiedadesLimitadas){
...
propiedadesSection.innerHTML += `
    <div>
        <a href="/propiedades_venta.html" class="btn btn-dark">Ver todas las propiedades en alquiler</a>
    </div>`;


const propiedadesSectionalquiler = document.querySelector("#rowalquiler")
const propiedadesLimitadasalquiler = propiedades_alquiler.slice(0, 3)

for(propiedad of propiedadesLimitadasalquiler){
    propiedadesSectionalquiler.innerHTML += `
        <div class="col-md-4 mb-4">
            <div class="card">
                <img
                    src="${propiedad.src}"
